...
import { speakFrenchWhenReady } from '../utils/frenchSpeech';
      ...
      {card && (
        <div className="noir-card overflow-hidden fade-up fade-up-3">
          ...
          <div className="p-8 lg:p-10 text-center" style={{ borderBottom: '1px solid rgba(232, 227, 216, 0.04)' }}>
            ...
            <button
              onClick={() => void speakFrenchWhenReady(card.french)}
              className="mt-4 inline-flex items-center gap-2 px-4 py-2 rounded-full text-[13px] text-creme-300 transition-all duration-400 hover:text-creme-100"
                    ...
                    {card.exampleSentences.map((ex, i) => (
                      ...
                      >
                        <div className="flex items-start justify-between gap-2">
                          ...
                          <button
                            onClick={() => void speakFrenchWhenReady(ex.french)}
                            className="text-creme-400 hover:text-creme-200 shrink-0 transition-colors duration-300"
                          >
                            🔊
                          </button>
                        </div>
