    ...
    >
      ...
      >
        ...
        <form onSubmit={submit} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder={mode === 'login' ? 'Admin' : 'Your name'}
            />
          </div>
          <div>
        ...
        <p className="text-[11px] text-creme-500 text-center leading-relaxed">
          Teacher: username <span className="text-creme-300">Admin</span>, password{' '}
          <span className="text-creme-300">admin</span>. Student accounts can register here; your progress is saved on this device only.
        </p>
      </div>
    </div>
  );
